# RailsAdmin config file. Generated on April 23, 2013 09:31
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Category', 'Order', 'Project', 'Service', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Order', 'Project', 'Service', 'User']
  ...
  #     configure :technicalities, :text 
  #     configure :aesthetics, :text 
  #     configure :status, :string 
  #     configure :target_date, :date 
  #     configure :start_date, :date 
  #     configure :number_of_workers, :integer 
